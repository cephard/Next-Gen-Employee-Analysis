...
## Project Background
Next Gen Corp. is a growing technology company focused on developing innovative solutions in the software
...
To ensure continued success, Next Gen Corp. needs to optimize employee retention, track employee
...
The company's main database structure as seen below consists of the following tables:
...
| **Department Table:**		| Contains the list of departments within Next Gen Corp. (e.g., Engineering, Sales, HR, Marketing). |
...
The company has spent a total of *$4.85M* on payroll, and the highest earning employees are *26* (**in this case high earners have salaries of $80K and above**). The *9* top performers represent the number of times employees achieved a perfect *5/5* score, while the *45* poor performers represent instances of low scores. These numbers might be higher than the actual number of employees who attained a perfect score or scored *3.5* or below.  
